...
DEPENDS = "gcr intltool-native jansson libnotify libsecret networkmanager mobile-broadband-provider-info gtk+3 glib-2.0 libgudev iso-codes glib-2.0-native libtool libtool-native libgcrypt p11-kit"
