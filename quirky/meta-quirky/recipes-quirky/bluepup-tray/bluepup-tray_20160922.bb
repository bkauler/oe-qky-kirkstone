...
#NO, this didn't work!
#(i know why, the variable should only be ERROR_QA_remove)
##20200919 this is a quick hack, really should fix it...
## (this will change it to a warning only)...
#ERROR_QA_remove_bluepup-tray = "license-checksum"
#instead, have created meta/COPYING.GPLv2
