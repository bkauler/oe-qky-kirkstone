...
# error: "glib-gettextize: command not found" ...fix set dep 'glib-2.0-native'
# BK note: dep 'intltool-native' fixed compile error "intltoolize: command not found"
DEPENDS = "libart-lgpl libpng cairo zlib gtk+ libxml2 intltool-native glib-2.0 glib-2.0-native"

# 2020-09-18 removed 'gnome'
