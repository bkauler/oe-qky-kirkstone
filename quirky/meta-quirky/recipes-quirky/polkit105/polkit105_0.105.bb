...
DEPENDS = "expat intltool-native glib-2.0 libxslt glib-2.0-native \
      ...
      gobject-introspection-native gtk-doc-native"
...
FILES_${PN} = "${datadir}/dbus-1 ${datadir}/polkit-1 ${libdir}/polkit-1"
...
#20200919
#ERROR: polkit105-0.105-r0 do_package_qa: QA Issue: /usr/lib/polkit-1/extensions/libnullbackend.so contained in package polkit105 requires libpolkit-backend-1.so.0()(64bit), but no providers found in RDEPENDS_polkit105? [file-rdeps]
