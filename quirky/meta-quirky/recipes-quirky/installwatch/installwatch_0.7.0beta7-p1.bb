...
# 20210528 compile failed glibc 2.33. got patch from here:
# https://bbs.archlinux.org/viewtopic.php?pid=1968712
...
RDEPENDS:installwatch += "bash"

# FILES_installwatch += "${libdir}/installwatch.so"
