...
#20200921 added pango and harfbuzz
DEPENDS = "gtk+ libx11 glib-2.0 libpng pango harfbuzz"
...
#20200921 added -lharfbuzz
LDFLAGS += "-lgtk-x11-2.0 -lgdk-x11-2.0 -lX11 -lgobject-2.0 -lglib-2.0 -lharfbuzz"
...
#20200921 pango wants hb.h, looking in wrong place...
do_compile:prepend() {
 cp -a -f ${WORKDIR}/recipe-sysroot/usr/include/harfbuzz/*.h ${WORKDIR}/recipe-sysroot/usr/include/
}
