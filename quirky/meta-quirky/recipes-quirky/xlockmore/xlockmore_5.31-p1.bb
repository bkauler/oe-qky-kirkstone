...
do_compile() {
    ...
    #20200922 dunfell, getting this error:
    #| util.c:158:8: error: 'DOMAIN' undeclared (first use in this function); did you mean 'SO_DOMAIN'?
    #|   158 |   case DOMAIN:
    #this is a problem with glibc 2.27+: https://github.com/flang-compiler/flang/issues/475
    echo '
