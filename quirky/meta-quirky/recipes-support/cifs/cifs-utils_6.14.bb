...
# 20211215 bump r6 to r7...  20220131 removed...
#PR = "r${@int(PR_NUM) + 1}"
...
DEPENDS += "libtalloc samba keyutils"

#20211215 remove "cap" (--with-libcap breaks mount.cifs)...
PACKAGECONFIG ??= ""
#PACKAGECONFIG[cap] = "--with-libcap,--without-libcap,libcap"

# 20211215 let the configure script decide these...
...
#20211215 make sure...
EXTRA_OECONF = "--without-libcap --disable-pam --disable-systemd"
