...
DEPENDS:append = " pulseaudio v4l-utils x265 libarchive libtool-native"

DEPENDS:remove = "avahi"
DEPENDS:remove = "fribidi"

PACKAGECONFIG:append = " mad a52 jack libass libva speex vpx qt5 dvdnav \
